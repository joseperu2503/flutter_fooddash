...
class AppColors {
  ...
  static const Color gray50 = Color(0xFFf6f9ff);
  static const Color gray100 = Color(0xFFf0f3ff);
  static const Color gray200 = Color(0xFFe7ebf7);
  static const Color gray300 = Color(0xFFd8dbe8);
  static const Color gray400 = Color(0xFFb5b8c4);
  static const Color gray500 = Color(0xFF9598a4);
  static const Color gray600 = Color(0xFF6d707b);
  static const Color gray700 = Color(0xFF595c67);
  static const Color gray800 = Color(0xFF3b3e48);
  static const Color gray900 = Color(0xFF1a1d26);
